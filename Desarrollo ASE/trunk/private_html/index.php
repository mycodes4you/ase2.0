...
if(validaAcceso('1055000', $dbpfx) == '1' || ($solovalacc != '1' && ($_SESSION['rol02']=='1' || $_SESSION['rol04']=='1'))) {
	...
	//echo '<pre>';
	$preg4 = "SELECT f.orden_id, f.fact_cobrada, o.orden_fecha_de_entrega, o.orden_estatus FROM " . $dbpfx . "facturas_por_cobrar f, " . $dbpfx . "ordenes o WHERE f.fact_cobrada < 2 AND f.fact_tipo < 3 AND f.orden_id = o.orden_id AND o.orden_fecha_de_entrega >= '$feini' AND (o.orden_estatus < '30' OR o.orden_estatus = '99')";
	$matr4 = mysql_query($preg4) or die("ERROR: Fallo selección de facturas! ".$preg4);
	
	//echo '<big>' . $preg4 . '</big><br>';
	while($fact = mysql_fetch_array($matr4)) {
		...
		if($fact['fact_cobrada'] == '1') {
			...
			if($mes == 1){
				//echo 'mes ' . $mes . ' no cobradas ' .  $ofc[$mes] . '<br>';
				//echo 'Orden no cobrada ' . $fact['orden_id'] . '<br>';
			}
			$ofsc[$mes]++;
		}
	...
	$pregunta = "SELECT orden_id, orden_estatus, orden_ref_pendientes, orden_ubicacion, orden_fecha_recepcion, orden_fecha_promesa_de_entrega, orden_fecha_de_entrega, orden_fecha_ultimo_movimiento FROM " . $dbpfx . "ordenes WHERE orden_fecha_recepcion >= '" . date('Y-m-d 00:00:00', (time() - (180*24*3600))) . "'";
...
//		if($mes > 2) {$mes=3;}
		...
		//echo '<pre> orden ' . $ord['orden_id'] . '<br>';
		//print_r($trab_no_fact);
		//echo 'van ' . $osf[$mese] . ' del mes ' . $mese . '<br>';
		//echo '</pre>';
		unset($trab_no_fact);
		...
		if($ord['orden_estatus'] >= 91 || $ord['orden_estatus'] == 16 || $ord['orden_estatus'] == 5 || $ord['orden_estatus'] == 6 ) {

			$ote[$ord['orden_estatus']][$mes]++;

		} elseif($ord['orden_estatus'] < 30 && $ord['orden_fecha_de_entrega']){
...
// --------- Bloque de documentación ------------------
	...
	echo '				<table cellpadding="0" cellspacing="0" border="1" style="border-radius: 10px; margin-right: 10px;margin-bottom: 5px;margin-top: 5px;" width="100%" class="bloque_fila centrado">
							<tr>
								<td width="60%" style="border-top-left-radius: 10px;" class="cabeza_tabla" style="text-align:left;" rowspan="2">' . PANEL_CONTROL_1 . '</td>
								<td width="10%" colspan="4" style="border-top-right-radius: 10px;" class="cabeza_tabla">'. $lang['Días'].'</td>
							</tr>
							<tr>
								<td width="10%" class="cabeza_tabla">1</td>
								<td width="10%" class="cabeza_tabla">2 a 3</td>
								<td width="10%" class="cabeza_tabla">4 a 6</td>
								<td width="10%" class="cabeza_tabla">7 o +</td>
							</tr>'."\n";
...
//		if($ot[$v][3]!='' || $ot[$v][4]!='') { $ot[$v][3] = $ot[$v][3] + $ot[$v][4]; }
		...
		if($ot[$v][3] == '0') { $ot[$v][3] = '';}
		echo '							
							<tr class="bloque_fila"><td style="text-align:left;">
...
// --------- Bloque de Reparación ------------------
	...
	echo '				<table cellpadding="0" cellspacing="0" border="1" style="border-radius: 10px; margin-right: 10px;margin-bottom: 5px;margin-top: 5px;" width="100%" class="bloque_fila centrado">
							<tr>
								<td width="60%" style="border-top-left-radius: 10px;" class="cabeza_tabla" style="text-align:left;" rowspan="2">' . PANEL_CONTROL_2 . '</td>
								<td width="10%" colspan="4" style="border-top-right-radius: 10px;" class="cabeza_tabla">'. $lang['Días'].'</td>
							</tr>
							<tr>
								<td width="10%" class="cabeza_tabla">1 a 6</td>
								<td width="10%" class="cabeza_tabla">7 a 12</td>
								<td width="10%" class="cabeza_tabla">13 a 19</td>
								<td width="10%" class="cabeza_tabla">20 o +</td>
							</tr>'."\n";
...
//		if($otrit[3]!='' || $otrit[4]!='') { $otrit[3] = $otrit[3] + $otrit[4]; }
		...
		echo '							
							<tr class="bloque_fila">
								...
								<td>
									<a href="reportes.php?accion=tabla&rit=1&n=4">'.$otrit[4].'</a></td><td><a href="reportes.php?accion=tabla&rit=1&n=5">'.$otrit[5].'</a>
								</td>
							</tr>'."\n";
...
// --------- Bloque de Vehículos en Proceso ------------------
	...
	echo '			<div style="clear: both;"></div><div class="col-lg-6 col-md-6 col-sm-6">
						<table cellpadding="0" cellspacing="0" border="1" style="border-radius: 10px; margin-right: 10px;margin-bottom: 5px;margin-top: 5px;" width="100%" class="bloque_fila centrado">
							<tr>
								<td width="60%" style="border-top-left-radius: 10px;" class="cabeza_tabla" style="text-align:left;" rowspan="2">' . PANEL_CONTROL_3 . '</td>
								<td width="10%" colspan="4" style="border-top-right-radius: 10px;" class="cabeza_tabla">'. $lang['Días'].'</td>
							</tr>
							<tr>
								<td width="10%" class="cabeza_tabla">1 a 6</td>
...
// --------- Bloque de Terminados ------------------
	...
	echo '			<div class="col-lg-6 col-md-6 col-sm-6">
						<table cellpadding="0" cellspacing="0" border="1" style="border-radius: 10px; margin-right: 10px;margin-bottom: 5px;margin-top: 5px;" width="100%" class="bloque_fila centrado">
							<tr>
								<td width="60%" style="border-top-left-radius: 10px;" class="cabeza_tabla" style="text-align:left;" rowspan="2">'. $lang['Ordenes en Etapa de Entrega'].'</td>
								<td width="10%" colspan="4" style="border-top-right-radius: 10px;" class="cabeza_tabla">'. $lang['Días'].'</td>
							</tr>
							<tr>
								<td width="10%" class="cabeza_tabla">1 a 6</td>
...
// --------- Bloque de Facturables ------------------
	...
	echo '			<div style="clear: both;"></div><div class="col-lg-6 col-md-6 col-sm-6">
						<table cellpadding="0" cellspacing="0" border="1" style="border-radius: 10px; margin-right: 10px;margin-bottom: 5px;margin-top: 5px;" width="100%" class="bloque_fila centrado">
							<tr>
								<td width="60%" style="border-top-left-radius: 10px;" class="cabeza_tabla" style="text-align:left;">'. $lang['Entregas Facturables por Mes'].'</td>
								<td width="10%" class="cabeza_tabla">'.$etiqmes[0].'</td>
								<td width="10%" class="cabeza_tabla">'.$etiqmes[1].'</td>
								<td width="10%" class="cabeza_tabla">'.$etiqmes[2].'</td>
								<td width="10%" class="cabeza_tabla" style="border-top-right-radius: 10px;">'. $lang['Meses Pas'].'</td>
							</tr>'."\n";
...
//	if($ofc[3]!='' || $ofc[4]!='') { $ofc[3] = $ofc[3] + $ofc[4]; }
	...
	echo '							
							<tr class="bloque_fila">
								<td style="text-align:left;">
									<a style="font-size: 1.0em; text-decoration: underline;" href="reportes.php?accion=finanzas&estatusflt=5&mes_r=4&ofc=1">' . $lang['Facturas cobradas'] . '</a>
								</td>
								<td>
									<a href="reportes.php?accion=finanzas&estatusflt=5&mes_r=0&ofc=1">'.$ofc0[0].'</a>
								</td>
								<td>
									<a href="reportes.php?accion=finanzas&estatusflt=5&mes_r=1&ofc=1">'.$ofc0[1].'</a>
								</td>
								<td>
									<a href="reportes.php?accion=finanzas&estatusflt=5&mes_r=2&ofc=1">'.$ofc0[2].'</a>
								</td>
								<td>
									<b><big>'.$ofc0[3].'</big></b>
								</td>
	...
	echo '							
							<tr class="bloque_fila"><td style="text-align:left;">
								<a style="font-size: 1.0em; text-decoration: underline;" href="reportes.php?accion=finanzas&estatusflt=4&mes_r=4&estatusflt=6">' . $lang['Facturas sin cobrar'] . '</a>
							</td>
							<td>
								<a href="reportes.php?accion=finanzas&estatusflt=4&mes_r=0&estatusflt=6">'.$ofsc0[0].'</a>
							</td>
							<td>
								<a href="reportes.php?accion=finanzas&estatusflt=4&mes_r=1&estatusflt=6">'.$ofsc0[1].'</a>
							</td>
							<td>
								<a href="reportes.php?accion=finanzas&estatusflt=4&mes_r=2&estatusflt=6">'.$ofsc0[2].'</a>
							</td>
							<td>
								<b><big>'.$ofsc0[3].'</big></b>
							</td>
	...
	echo '							
						<tr class="bloque_fila">
							<td style="text-align:left;">
								<a style="font-size: 1.0em; text-decoration: underline;" href="reportes.php?accion=finanzas&estatusflt=7&mes_r=4">' . $lang['Trabajos pendientes por facturar'] . '</a>
							</td>
							<td>
								<a href="reportes.php?accion=finanzas&mes_r=0&estatusflt=7">'.$osf0[0].'</a>
							</td>
							<td>
								<a href="reportes.php?accion=finanzas&mes_r=1&estatusflt=7">'.$osf0[1].'</a>
							</td>
							<td>
								<a href="reportes.php?accion=finanzas&mes_r=2&estatusflt=7">'.$osf0[2].'</a>
							</td>
							<td>
								<b><big>'.$osf0[3].'</big></b>
							</td>
...
//		if($ote[$v][3]!='' || $ote[$v][4]!='') { $ote[$v][3] = $ote[$v][3] + $ote[$v][4]; }
		...
		echo '							
						...
						if($w == 99 || $w == 6){
							echo '<a style="font-size: 1.0em; text-decoration: underline;" href="reportes.php?accion=comentreg&nomrep=Entregados&mes_r=4&tipo_reparacion=reparados&estatus_cerrado=' . $w . '">' . constant('ORDEN_ESTATUS_'.$w) . '</a>'."\n";
						} elseif($w == 300){
							echo '<a style="font-size: 1.0em; text-decoration: underline;" href="reportes.php?accion=comentreg&nomrep=Entregados&mes_r=4&tipo_reparacion=reparados&estatus_cerrado=sin-cerrar">Entregados sin cerrar</a>'."\n";
						} else{
							echo '<a style="font-size: 1.0em; text-decoration: underline;" href="reportes.php?accion=tabla&id='.$w.'&mes=t">' . constant('ORDEN_ESTATUS_'.$w) . '</a>'."\n";
						}
		...
		// --- Entra condición ---
 		...
 		echo '
						...
						if($w == 99 || $w == 6){
							echo '<a href="reportes.php?accion=comentreg&nomrep=Entregados&mes_r=0&tipo_reparacion=reparados&estatus_cerrado=' . $w . '">'.$ote0[$w][0].'</a>'."\n";
						} elseif($w == 300){
							echo '<a style="font-size: 1.0em; text-decoration: underline;" href="reportes.php?accion=comentreg&nomrep=Entregados&mes_r=0&tipo_reparacion=reparados&estatus_cerrado=sin-cerrar">'.$ote0[$w][0].'</a>'."\n";
						} else{
							echo '<a href="reportes.php?accion=tabla&id='.$w.'&mes=0">'.$ote0[$w][0].'</a>'."\n";
						}
 		echo '						
							</td>
							<td>'."\n";
						...
						if($w == 99 || $w == 6){
							echo '<a href="reportes.php?accion=comentreg&nomrep=Entregados&mes_r=1&tipo_reparacion=reparados&estatus_cerrado=' . $w . '">'.$ote0[$w][1].'</a>'."\n";
						} elseif($w == 300){
							echo '<a text-decoration: underline;" href="reportes.php?accion=comentreg&nomrep=Entregados&mes_r=1&tipo_reparacion=reparados&estatus_cerrado=sin-cerrar">'.$ote0[$w][1].'</a>'."\n";
						} else{
							echo '<a href="reportes.php?accion=tabla&id='.$w.'&mes=1">'.$ote0[$w][1].'</a>'."\n";
						}
 		echo '
							</td>
							<td>'."\n";
						...
						if($w == 99 || $w == 6){
							echo '<a href="reportes.php?accion=comentreg&nomrep=Entregados&mes_r=2&tipo_reparacion=reparados&estatus_cerrado=' . $w . '">'.$ote0[$w][2].'</a>'."\n";
						} elseif($w == 300){
							echo '<a text-decoration: underline;" href="reportes.php?accion=comentreg&nomrep=Entregados&mes_r=2&tipo_reparacion=reparados&estatus_cerrado=sin-cerrar">'.$ote0[$w][2].'</a>'."\n";
						} else{
							echo '<a href="reportes.php?accion=tabla&id='.$w.'&mes=2">'.$ote0[$w][2].'</a>'."\n";
						}
 		echo '
							</td>
							<td>'."\n";
...
// --------- Bloque de No Reparados ------------------
	...
	echo '				<table cellpadding="0" cellspacing="0" border="1" style="border-radius: 10px; margin-right: 10px;margin-bottom: 5px;margin-top: 5px;" width="100%" class="bloque_fila centrado">
							<tr>
								<td width="60%" style="border-top-left-radius: 10px;" class="cabeza_tabla" style="text-align:left;">' . PANEL_CONTROL_6 . '</td>
								<td width="10%" class="cabeza_tabla">'.$etiqmes[0].'</td>
								<td width="10%" class="cabeza_tabla">'.$etiqmes[1].'</td>
								<td width="10%" class="cabeza_tabla">'.$etiqmes[2].'</td>
								<td width="10%" class="cabeza_tabla" style="border-top-right-radius: 10px;">'. $lang['Meses Pas'].'</td>
...
// --------- Bloque de Recibidos por Tipo ------------------
	...
	echo '				<table cellpadding="0" cellspacing="0" border="1" style="border-radius: 10px; margin-right: 10px;margin-bottom: 5px;margin-top: 5px;" width="100%" class="bloque_fila centrado">
							<tr>
								<td width="60%" style="border-top-left-radius: 10px;" class="cabeza_tabla" style="text-align:left;">' . PANEL_CONTROL_7 . '</td>
								<td width="10%" class="cabeza_tabla">'.$etiqmes[0].'</td>
								<td width="10%" class="cabeza_tabla">'.$etiqmes[1].'</td>
								<td width="10%" class="cabeza_tabla">'.$etiqmes[2].'</td>
								<td width="10%" class="cabeza_tabla" style="border-top-right-radius: 10px;">'.$etiqmes[3].'</td>
							</tr>'."\n";
//	print_r($asegu);
	foreach($ase as $k => $v) {
		...
		echo '							
							<tr class="bloque_fila">
								<td style="text-align:left;">
									<a style="font-size: 1.0em; text-decoration: underline;" href="reportes.php?accion=cliente&mes_r=4&a='.$k.'">' . $v . ': '.$asegut.'</a>
								</td>
								<td>
									<a href="reportes.php?accion=cliente&mes_r=0&a='.$k.'">'.$asegu[$k][0].'</a>
								</td>
								<td>
									<a href="reportes.php?accion=cliente&mes_r=1&a='.$k.'">'.$asegu[$k][1].'</a>
								</td>
								<td>
									<a href="reportes.php?accion=cliente&mes_r=2&a='.$k.'">'.$asegu[$k][2].'</a>
								</td>
								<td>
									<a href="reportes.php?accion=cliente&mes_r=3&a='.$k.'">'.$asegu[$k][3].'</a>
								</td>
							</tr>'."\n";
	}
	echo '						
...
// --------- Bloque de Entregados por Tipo ------------------
	...
	echo '				<table cellpadding="0" cellspacing="0" border="1" style="border-radius: 10px; margin-right: 10px;margin-bottom: 5px;margin-top: 5px;" width="100%" class="bloque_fila centrado">
							<tr>
								<td width="60%" style="border-top-left-radius: 10px;" class="cabeza_tabla">' . PANEL_CONTROL_8 . '</td>
								<td width="10%" class="cabeza_tabla">'.$etiqmes[0].'</td>
								<td width="10%" class="cabeza_tabla">'.$etiqmes[1].'</td>
								<td width="10%" class="cabeza_tabla">'.$etiqmes[2].'</td>
								<td width="10%" class="cabeza_tabla" style="border-top-right-radius: 10px;">'.$etiqmes[3].'</td>
...
//		print_r($aseen[$k]); echo '<br>';
		...
		echo '							
							<tr class="bloque_fila">
								<td style="text-align:left;">
									<a style="font-size: 1.0em; text-decoration: underline;" href="reportes.php?accion=cliente&mfe=t&a='.$k.'&tipo_reparacion=reparados">' . $v . ': '.$aseent.'</a>
								</td>
								<td>
...
// --------- Bloque de Ubicación ------------------
	...
	echo '				<table cellpadding="0" cellspacing="0" border="1" style="border-radius: 10px; margin-right: 10px;margin-bottom: 5px;margin-top: 5px;" width="100%" class="bloque_fila centrado">
							<tr>
								<td width="60%" style="border-top-left-radius: 10px;" class="cabeza_tabla">' . PANEL_CONTROL_9 . '</td>
								<td width="10%" class="cabeza_tabla">'.$etiqmes[0].'</td>
								<td width="10%" class="cabeza_tabla">'.$etiqmes[1].'</td>
								<td width="10%" class="cabeza_tabla">'.$etiqmes[2].'</td>
								<td width="10%" style="border-top-right-radius: 10px;" class="cabeza_tabla">'. $lang['Meses Pas'].'</td>
							</tr>'."\n";
	...
	echo '							
							<tr class="bloque_fila">
								...
								<td>
									<a href="reportes.php?accion=tabla&ottp=1&mfr=2">'.$otp[2].'</a></td><td><a href="reportes.php?accion=tabla&ottp=1&mfr=3">'.$otp[3].'</a>
								</td>
							</tr>'."\n";
...
//	echo $num_cols;
		echo '<div style="clear: both;"></div>
				<div class="col-lg-12 col-md-12 col-sm-12">
					<table cellspacing="0" cellpadding="2" border="1" class="avisos">'."\n";
		echo '					<tr>
		...
		echo '										</select>&nbsp;&nbsp;' . "\n";
		echo '								<input type="submit" class="btn btn-success" name="enviar" value="'. $lang['Enviar'].'" />';
		echo '							</form>
						</td>'."\n";
      		...
      		echo '				<table cellspacing="0" cellpadding="2" border="0" width="100%">
				...
				while($comen = mysql_fetch_array($matrc1)) {
					...
					if($comen['orden_id'] == '9999995' ) {
						...
						echo '									<button class="btn btn-success"name="activar" value="1" type="submit">' . $lang['CotAcept'] . '</button>'."\n";
						echo '									<button class="btn btn-success"name="activar" value="0" type="submit">' . $lang['CotPosp'] . '</button>'."\n";
						echo '									<button class="btn btn-success"name="activar" value="2" type="submit">' . $lang['CotBloq'] . '</button>'."\n";
						echo '									<a href="proveedores.php?accion=consultar&prov_id=' . $provid[0] . '" target="_blank"><button class="btn btn-success"type="button">' . $lang['ProvVer'] . '</button></a>'."\n";
					} else {
...
// -----------------------------------------------------
		...
		elseif(isset($estatus) && $estatus!='') {
			...
			$pregunta = "SELECT * FROM " . $dbpfx . "ordenes WHERE orden_estatus = '" . $estatus . "' ORDER BY orden_id DESC";
			
		} else {
			echo '					<tr><td colspan="2">' . TABLA_AVISOS_ENC . '</td></tr>' . "\n";
			$pregunta = "SELECT a.al_codigo, a.al_preventivo, a.al_critico, a.al_vista, a.al_categoria, o.* FROM " . $dbpfx . "alertas a, " . $dbpfx . "ordenes o WHERE o.orden_estatus = a.al_estatus AND o.orden_categoria = a.al_categoria AND ";
   	...
   	$matriz = mysql_query($pregunta) or die($pregunta);
		...
		if ($num_cols>0) {
			...
			while($alerta = mysql_fetch_array($matriz)) {
				if(($alerta['al_codigo'] == $codigos[$_SESSION['codigo']][1]) || $rol!='' || $estatus!='' || ($alerta['orden_ubicacion'] == 'Transito' && $_SESSION['codigo']=='30') || $_SESSION['codigo']=='50' || $_SESSION['codigo']=='90') {
					...
					if($_SESSION['codigo']=='40' && $alerta['orden_estatus']>='24' && $alerta['orden_estatus']<='27' && $mostrar == '0') {
						...
						echo '</table></td>';
						$c++;
						if ($_COOKIE['window_width'] > '921') {
							if ($c == 3) { echo "\n" . '								</tr>' . "\n"; $c = 0; $j++; }
							if ($j < 2) { $fondo = 'obscuro'; } else { $fondo = 'claro'; $j = 0; }
						}
						elseif ($_COOKIE['window_width'] < '920' && $_COOKIE['window_width'] > '631') {
							if ($c == 2) { echo "\n" . '								</tr>' . "\n"; $c = 0; $j++; }
							if ($j < 2) { $fondo = 'obscuro'; } else { $fondo = 'claro'; $j = 0; }
						}
						elseif ($_COOKIE['window_width'] < '630') {
							if ($c == 1) { echo "\n" . '								</tr>' . "\n"; $c = 0; $j++; }
							if ($j < 2) { $fondo = 'obscuro'; } else { $fondo = 'claro'; $j = 0; }
						}
			...
			if(!isset($estaus) && !isset($rol)) {
				echo '					<tr><td colspan="2">' . TABLA_AVISOS_SUB . '</td></tr>' . "\n";
...
?>
			...
			<div class="col-lg-6 col-md-4 col-sm-12"><?php
			...
			// ------ Mensajes Internos ---
				echo '					<form action="comentarios.php?accion=visto" method="post" enctype="multipart/form-data">'."\n";
				echo '						<table cellspacing="0" cellpadding="2" border="1" width="100%" style="border-radius: 10px;">
										<tr style="border-radius: 10px;">
											<td style="text-align:left; border-radius: 10px;">
				...
				while($comen = mysql_fetch_array($matrc1)) {
					...
					if($comen['orden_id'] == '9999995' ) {
						...
						echo '									<input type="hidden" name="prov_id" value="' . $provid[0] . '" />
												<input type="hidden" name="visto" value="' . $comen['bit_id'] . '" />'."\n";
						echo '									<button class="btn btn-success"name="activar" value="1" type="submit">' . $lang['CotAcept'] . '</button><br>'."\n";
						echo '									<button class="btn btn-success"name="activar" value="0" type="submit">' . $lang['CotPosp'] . '</button><br>'."\n";
						echo '									<button class="btn btn-success"name="activar" value="2" type="submit">' . $lang['CotBloq'] . '</button><br>'."\n";
						echo '									<a href="proveedores.php?accion=consultar&prov_id=' . $provid[0] . '" target="_blank"><button class="btn btn-success"type="button">' . $lang['ProvVer'] . '</button></a>'."\n";
					} else {
						echo '									<a href="ordenes.php?accion=consultar&orden_id=' . $comen['orden_id'] . '" target="_blank">Mensaje en la OT ' . $comen['orden_id'] . '</a><br>'."\n";
						echo '									El ' . $comen['fecha_com'] . ' de ' . $comen['nombre'] . ' ' . $comen['apellidos'] . '<br>'."\n";
						echo '									' . $comen['comentario']. '<br>'."\n";
						if($comen['recordatorio'] != 1) {
							echo '									<button class="btn btn-success"name="visto" value="' . $comen['bit_id'] . '" type="submit">' . $lang['Visto'] . '</button><br>'."\n";
						}
						echo '				<input type="hidden" name="orden_id" value="' . $comen['orden_id'] . '" />
							<input type="hidden" name="pagina" value="index.php" />'."\n";
					}
