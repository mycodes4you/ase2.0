...
//					print_r($cust);
			...
			if($inv['inv_int'][29] == '1'){ echo 'Automática';}
			if($inv['inv_int'][29] == '2'){ echo 'Estándar';}
...
//			echo '		<td style="width:277px; vertical-align: top; padding-right:3px; font-size:10px;">'."\n";
			...
			echo '			<table cellpadding="0" cellspacing="0" border="0" class="izq" width="100%" style="font-size:0.8em;">'."\n";
                        ...
                        echo '                          <tr><td style="width:100%; line-height:12px;">La Empresa no se hace responsable de objetos no reportados al Asesor de Servicio al momento del inventario.</td></tr>'."\n";
			echo '				<tr style="height:3px;"><td></td></tr>'."\n";
			...
			echo '
			<img src="particular/contrato-el-rosedal.png" ALT="Contrato">'."\n";
