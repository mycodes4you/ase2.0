...
//				$codigo = $orden_id . ' ' . $sub['sub_orden_id'] . ' ' . $sub['sub_operador'];
			...
			echo '				<tr><td style="text-align:left; font-size:22px; font-weight:bold; line-height:30px; width:748px;"><strong>Tarea ' . $sub['sub_orden_id'] . ': ' . constant('NOMBRE_AREA_' . strtoupper($sub['sub_area'])) . ' ' . $sub['sub_descripcion'] . '<br>' . $lang['Operador'] . ': ' . $sub['sub_operador'] . ' ' . $usur[$sub['sub_operador']] . '</strong></td><td valign="top" style="width:100px;" ><img src="' . $imagenseg . '" alt="Código QR registro de seguimiento de reparación" width="100"></td></tr></table>'."\n";
			echo '			<table cellpadding="0" cellspacing="0" border="1" class="izquierda" width="840">'."\n";
