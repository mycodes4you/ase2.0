...
// --- Determina la tarifa a utilizar para cada JT basado en la cantidad de OTs logradas ---
// --- Crea el recibo de pago para cada JT ---
	while ($ases = mysql_fetch_array($matrase)) {
...
// --- Agregar comisiones fijas para cada JT ---
