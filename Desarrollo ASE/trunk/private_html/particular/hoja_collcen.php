...
//			echo '			<table cellpadding="0" cellspacing="0" border="0" width="840" class="izquierda">
		echo '				<tr><td><span style="font-size:10px; font-weight:bold;">Orden de Reparación: ' . $orden_id . '</span></td><td>Cliente: ' . $cust['cliente_nombre'] . ' ' . $cust['cliente_apellidos'] . '. RFC:</td></tr>';
...
//			echo '		<td style="width:277px; vertical-align: top; padding-right:3px; font-size:10px;">'."\n";
			...
			echo '				<tr><td colspan="4" rowspan="4" >¿El consumidor suministra las partes, refacciones o materiales para la prestación del servicio de reparación del vehículo?: Sí( ) No( )</td></tr>'."\n";
			...
			echo '		</td></tr>'."\n";
			echo '	</table>'."\n";
			echo '			<table cellpadding=".5" cellspacing="0" border="1" width="840">
				<tr><td colspan="2" style="text-align:center;"><small>RECEPCION</small></td><td colspan="2" style="text-align:left;"><small>Fecha y Hora de Entrega:</small></small></td></tr>
				<tr style="height:50px;"><td style="text-align:center; width:25%; vertical-align:bottom;">Nombre y firma del cliente</td>
