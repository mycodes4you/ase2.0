...
// --- Remplazadas por $valarr de la tabla de Valores -- $unidad = array("Pieza", "Litro", "Kilo", "Gramo", "Juego", "Servicio");
// --- Remplazadas por $valarr de la tabla de Valores -- $tangible = array(0 => "Mano de Obra", 1 => "Refacción", 2 => "Consumible", 3 => "Chatarra");
