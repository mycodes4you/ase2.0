...
'MO' => 'Mano de Obra',
'NoRegistros' => 'No se encontraron registros con esos datos.',
'NumSin' => 'Número de Siniestro',
'Operador' => 'Operador',
'OprTrab' => 'No se puede cambiar de Operario mientras está él está trabajando en la tarea, primero debe pausarla o terminarla.',
'Partes' => 'Refacciones',
'Placas' => ' Placas: ',
'SubDesc' => 'Esta tarea será descontada al usuario asignado. No se puede cambiar al operario.',
'Tiempo Extra' => '¿Tiempo Extra? Sí',
'Visto' => 'Resuelto',
'YaHayRD' => 'Ya existe Recibo de Destajo. No se puede cambiar al operario.',
);
