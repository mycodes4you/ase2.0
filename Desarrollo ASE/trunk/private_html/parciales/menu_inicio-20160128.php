<?php
	...
	if ($_SESSION['codigo'] > '0' && $_SESSION['codigo'] != '60') {
	...
	if ($resultado1060 == '1' || $_SESSION['rol02'] == '1' || $_SESSION['rol03'] == '1' || $_SESSION['rol04'] == '1' || $_SESSION['rol06'] == '1') {
...
//	echo '				<span style="padding-left: 10px;">Usuario: ' . $_SESSION['puesto'] . ' ' . $_SESSION['nombre'] . ' ' . $_SESSION['apellidos'] . '</span>'."\n";
	...
	if($_SESSION['codigo'] == '70') { echo ' style="font-size:28px; line-height: 120%;">'; } else { echo '>';} 
