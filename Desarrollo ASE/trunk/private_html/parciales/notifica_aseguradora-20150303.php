...
$contenido = '<p><strong>Estimados Clientes de ' . $asenoti[$aseguradora]['razon'] . '</strong>.<br>
<br>Les informamos que hoy ' . date('d-m-Y', time()) . ' ' . $situacion . ' el siguiente vehículo:</p><p><strong>' . $dato['marca'] . ' ' . $dato['tipo'] . ' ' . $dato['color'] . ' ' . $lang['Placas'] . $dato['placas'] . '</strong>.</p><p>Este vehículo ingresó con el siniestro ' . $reporte . ' que atendemos con la Orden de Trabajo ' . $orden_id . '.</p>'."\n";

$contenido .= '<p><br><br>Atentamente.<br><br>' . $_SESSION['nombre'] . ' ' . $_SESSION['apellidos'] . '<br>' . $nombre_agencia . '<br>' . $agencia_telefonos . '<br>' . $agencia_email . '</p>'."\n";
