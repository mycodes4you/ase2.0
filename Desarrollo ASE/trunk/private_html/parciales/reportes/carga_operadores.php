		...
		<div class="col-md-8">
			<div class="content-box-header">
				<div class="panel-title">
	  				<h2>Carga de Trabajo Asignada a Operarios</h2>
				</div>
			</div>
		</div>
	</div>		
		...
		<div class="col-md-8">
			<div id="content-tabla">
				<table cellspacing="0" class="table-new">
					<tr>
						<th><a href="reportes.php?accion=carga_operador&tipo_busq=detalle">TODOS LOS OPERADORES</STRONG></a></th>
						<th>VEHÍCULOS</th>
						<th>CARGA EN HORAS</th>
						<th>MANO DE OBRA AUTORIZADA</th>
					</tr>'."\n";
				...
				if($usr_cod[$key] == 60 && $usr_activo[$key] == 1) {
					...
					if($export == 1){ // ---- Hoja de calculo ----
						...
						$objPHPExcel->setActiveSheetIndex(0)
									...
									->setCellValue($d, $mo_autorizada[$key]);
						...
						echo '				
					<tr class="' . $fondo . '">
						<td style="text-align: left;"><big>' . $enlace . 	'</big></td>
						<td style="text-align: center;"><big>' . $vehiculos[$key] . '</big></td>
						<td style="text-align: right;"><big>' . $tiempo[$key] . '</big></td>
						<td style="text-align: right; ' .  $rojo_mo_aut . '"><big>$ ' .  number_format($mo_autorizada[$key], 2) . 	'</big></td>
					</tr>'."\n";
