<?php
			...
			if($accion==='confirma') {
				...
				if($MontoMO == '') { $MontoMO = number_format($motot, 2, '.', ''); }
				if($MontoPartes == '') { $MontoPartes = number_format($partes, 2, '.', ''); }
				...
				echo '			<tr><td>Folio de referencia de ficha de depósito de deducible</td><td><input type="text" name="fechaDepositoDeducible" value="' . $refDepositoDeducible . '" /></td></tr>'."\n";
				...
				echo '			<tr><td>Folio de referencia de ficha de depósito de demerito</td><td><input type="text" name="fechaDepositoDeducible" value="' . $refDepositoDemerito . '" /></td></tr>'."\n";
