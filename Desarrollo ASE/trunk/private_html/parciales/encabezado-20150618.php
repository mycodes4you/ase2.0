...
<html>
<head>
<title><?php echo $agencia . ' - ' . $titulo ; ?></title>
<meta name="keywords" content="<?php echo $keywords ; ?>">
<meta name="description" content="<?php echo $pag_desc ; ?>">
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<!-- <meta http-equiv="content-type" content="application/xhtml+xml; charset=UTF-8"> -->
<meta name="generator" content="Bluefish 2.2.5" >
<?php if(basename($_SERVER['PHP_SELF'])=='index.php' || basename($_SERVER['PHP_SELF'])=='monitoreo.php' || basename($_SERVER['PHP_SELF'])=='produccion.php') { echo '<meta http-equiv="refresh" content="300">'."\n";} ?>
...
<?php if($simulador == 1) { echo '<link href="css/simulador.css" type="text/css" rel="stylesheet" />'."\n"; } ?>
<script type="text/javascript" src="parciales/dinamico.js"></script>
<?php
...
if (basename($_SERVER['PHP_SELF'])=='reg-express.php' || basename($_SERVER['PHP_SELF'])=='presupuestos.php') {
	echo '<script type="text/javascript">
