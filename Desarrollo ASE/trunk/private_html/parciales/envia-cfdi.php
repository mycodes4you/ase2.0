	...
	<tr>
		...
		<td class="container" bgcolor="#F2F2F2">
			<div class="content">
				...
				<p class="lead">Anexo encontrará los archivos de nuestra factura ' . $comprobante_serie . $comprobante_folio . ' del Centro de Reparación Automotriz ' . $nombre_agencia . ', que corresponden a los trabajos realizados a la Orden de Trabajo ' . $orden_id;
