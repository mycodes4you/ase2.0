...
function validarExp() {
 	...
 	if( document.rapida.siexiste.value == "0" ) {
   ...
   if( document.rapida.colores.value == "" )
   {
   ...
   if( document.rapida.servicio.value == "4" && document.rapida.orden_adm.value == "" && document.rapida.admdocs.value == "1")
   {
   ...
   if( document.rapida.servicio.value == "4" && document.rapida.levante.value == "" && document.rapida.admdocs.value == "1")
   {
     alert( "Por favor agregue imagen de la Hoja de Daños" );
   ...
   if( document.rapida.servicio.value == "2" && document.rapida.garantia.value == "" )
   {
