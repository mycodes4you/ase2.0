...
if($inicio == '' || $fin == ''){ // No ejecutamos script
	...
	$preg0 = "SELECT pedido_id, pedido_estatus, orden_id FROM " . $dbpfx . "pedidos WHERE pedido_id >= '" . $inicio . "' AND pedido_id <= '" . $fin . "' LIMIT 200";
	...
	if($filas > 0){
		...
		// --- Redirigir aumentado el rango en 100 ---
		$nuevo_inicio = $fin + 1;
		$nuevo_fin = $fin + 100;
