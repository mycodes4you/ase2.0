...
//		echo '<br>' . $preg2;
		...
		while($gsub = mysql_fetch_array($matr2)) {
         ...
         echo '
                    <td>' . strtoupper($ord['orden_vehiculo_tipo']) . '</td><td>' . strtoupper($ord['orden_vehiculo_modelo']) . '</td><td>' . strtoupper($ord['orden_vehiculo_marca']) . '</td><td>' . $ord['orden_vehiculo_placas'] . '</td><td style="padding-left:10px; padding-right:10px;">' . constant('ORDEN_ESTATUS_' . $ord['orden_estatus']) . '</td>';
