	...
	if ($orden_id!='' || $oid!='') {
		...
		if ($num_cols>0) {
			...
			if($error == 'no') {
				...
				echo '			<table cellspacing="2" cellpadding="2" border="0">'."\n";
				echo '				<tr><td rowspan="2"><a href="ordenes-1.2.php?accion=consultar&orden_id=' . $orden_id . '"><img src="idiomas/' . $idioma . '/imagenes/otra-vista.png" alt="Prueba Otra Vista" title="Prueba Otra Vista"></a></td><td align="left" colspan="3"><span style="font-weight:bold; font-size:1.2em;">Orden de trabajo: ' . $orden['orden_id'] . ' Cliente: <a href="personas.php?accion=consultar&cliente_id=' . $orden['orden_cliente_id'] . '">' . $orden['orden_cliente_id'] . '</a> Vehículo: <a href="vehiculos.php?accion=consultar&vehiculo_id=' . $orden['orden_vehiculo_id'] . '">' . $orden['orden_vehiculo_id'] . '</a></span></td></tr>'."\n";
