...
if ($accion==="consultar") {
	...
	if (validaAcceso('1095000', $dbpfx) == '1' || ($solovalacc != '1' && ($_SESSION['rol02']=='1' || $_SESSION['rol03']=='1' || $_SESSION['rol12']=='1'))) {
...
//	echo $preg0;
	...
	if(file_exists('../certificados/'.$agencia_rfc.'-certificado.php')) {
		if($facturas > 0) {
