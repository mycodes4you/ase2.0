...
if($servrespaldo != '') {
	...
	ssh2_scp_send($conecta, '/home/autoshop/domains/' . $_SERVER['HTTP_HOST'] . '/private_html/documentos/' . $qrnom[0] . '.pdf', '/home/autoshop/domains/' . $_SERVER['HTTP_HOST'] . '/private_html/documentos/' . $qrnom[0] . '.pdf', 0644);
}
