...
//	echo 'Estamos en la sección  consulta';
	if ($retorno == '1' || ($solovalacc != '1' && ($_SESSION['rol02']=='1' || $_SESSION['rol04']=='1' || $_SESSION['rol05']=='1' || $_SESSION['rol06']=='1' || $_SESSION['rol07']=='1'))) {
		// Acceso autorizado
	} else {
...
elseif ($accion==="consultar") {
	...
	if ($retorno == '1' || ($solovalacc !='1' && ($_SESSION['rol02']=='1' || $_SESSION['rol04']=='1' || $_SESSION['rol05']=='1' || $_SESSION['rol06']=='1'))) {
...
//			echo $mo_tmp;
		...
		if($cust['previa_estatus'] == '99') {
			...
			if($retorno0 == '1' || ($solovalacc !='1' && ($_SESSION['rol02']=='1' || $_SESSION['rol03']=='1' || $_SESSION['rol12']=='1'))) {
