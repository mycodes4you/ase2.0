...
echo '
			...
			<div>
			  <div>
			    <div class="col-lg-4 col-md-5 col-sm-6" style="margin: 5px;">
					<div style="box-shadow: 3px 4px 10px 0px #484848; border-top-left-radius: 10px; border-top-right-radius: 10px; background-color: white; margin-bottom: 10px;">
						<div class="row"><?php
							...
							echo '<div class="col-lg-10 col-md-10 col-10"><b>' . constant('ORDEN_ESTATUS_' . $orden['orden_estatus']) . '</b>';
							...
							foreach($reporte as $sin => $sindet) {
								...
								<table cellspacing="0" cellpadding="2" border="0" width="100%" style="background-color: ; text-align:right; line-height:12px;">'."\n";
									...
									echo '	<tr>
											...
											if($sindet['ase'] > 0) {
												echo 'Número de Siniestro: ' . $sin . '</td><td style="text-align: left; background-color: #65baec;"><b></b></td><td style="text-align: left; background-color: #5494e8;"><b></b></td><td style="text-align: left; background-color: #3b7dd3;"><b></b></td><td style="text-align: left; background-color: #2c5ba0;"><b></b></td></tr>'."\n";
											} else {
											// Valida acceso a mostrar registro de Anticipo.
											if(validaAcceso('1040085', $dbpfx) == 1) {
											echo '<a href="entrega.php?accion=regcobro&orden_id=' . $orden_id . '&anticipo=1">Recibir Anticipo</a></b></td>';
											}
									echo '		
											</td>
											<td style="text-align: left; background-color: #65baec;" rowspan="2"></td><td style="text-align: left; background-color: #5494e8;" rowspan="2"></td><td style="text-align: left; background-color: #3b7dd3;" rowspan="2"></td><td style="text-align: left; background-color: #2c5ba0;" rowspan="2"></td>
										</tr>';
									...
									echo '							<tr><td style="width:200px; vertical-align:top; text-align:left; background-color: white; height: 50px;" colspan="2"><img src="' . $ase[$sindet['ase']]['logo'] . '" alt="' . $ase[$sindet['ase']]['nic'] . '" title="' . $ase[$sindet['ase']]['nic'] . '"></td>
									...
									foreach($repdet[$sin] as $tarea => $val) {
										...
										elseif($orden['orden_estatus'] >= 12 && $orden['orden_estatus'] <= 15) { $peradmin = 0.8; }
										...
										if($_SESSION['codigo'] < '2000') {
											...
											echo '<a href="' . $tipo_prod . '.php?accion=consultar&orden_id=' . $orden_id . '#' . $tarea . '"><img src="imagenes/alarma_' . $barra . '.jpg" style="height: 20px; width: ' . ($peradmin * 44) . 'px; margin-right: 1px;margin-left: 1px;" /></a><br><a href="' . $tipo_prod . '.php?accion=consultar&orden_id=' . $orden_id . '#' . $tarea . '">' . round(($peradmin * 100),0) . '%</a>';
										} else {
										...
										if($cueref > 0) {
											...
											echo '								<td width="44" align="center"><b>No<br>Aplica</b></td>'."\n";
										}
...
?>
			    ...
			    <div class="col-lg-3 col-md-4 col-sm-5" style="margin: 5px;">
					<div style="row" align="center">
						...
						<div style="row" align="center">
  						...
  						<div style="row" align="center"><?php


							echo '<table style="box-shadow: 3px 4px 10px 0px #484848; border-radius: 10px;"><tr><td>';
							...
							//}
								...
								if((validaAcceso('1120005', $dbpfx) == '1' || $_SESSION['rol04'] == '1' || $_SESSION['rol06'] == '1' || $_SESSION['rol02'] == '1') && $_SESSION['codigo'] < '2000') {
								echo '<tr class="obscuro"><td style="text-align:center;" colspan="2"><br><form action="ordenes.php?accion=otcambiar&orden_id=' . $orden_id . '" method="post"><button class="btn btn-primary" type="submit"> <img src="idiomas/' . $idioma . '/imagenes/prod-editar.png" alt="' . $lang['Modificar Datos OT'] . '" title="' . $lang['Modificar Datos OT'] . '"> Modificar datos generales de la OT</button></form> <br></td></tr>';
								}
								...
								echo '				<tr class="obscuro"><td style="vertical-align:top;"><b>Recibido en:</b><br>' . $ubicaciones[$orden['orden_sitio_ingreso']] . '</td><td><b>Ubicación Actual</b><br>'."\n";
								if($cambubic == '1' && $orden['orden_estatus'] <= '39' && $orden['orden_estatus'] != '16') {
									if (validaAcceso('1040055', $dbpfx) == '1' || $_SESSION['rol04'] == '1' || $_SESSION['rol06'] == '1') {
										...
										foreach($ubicaciones as $uk => $uv) {
											...
											if($orden['orden_sitio_actual'] == $uk) { echo ' selected '; }
											echo '>' . $uv . '</option>'."\n";
										}
										echo '						</select><input type="hidden" name="orden_id" value="' . $orden_id . '" /></form>'."\n";
									}
								...
								echo '</td></tr>'."\n";
								echo '				<tr class="claro"><td colspan="2"><b>Lugar dentro de Ubicación actual: </b>' . $orden['orden_ubicacion'] . '</td></tr>'."\n";
								echo '				</table>'."\n";

								echo '				<table cellspacing="0" cellpadding="2" border="0" width="100%">'."\n";
								echo '				<tr class="obscuro"><td><b>Fecha de Recepción: </b></td><td>' . $orden['orden_fecha_recepcion'] . '</td></tr>'."\n";
								if($fcompcr == 1) {
									...
									echo '				<tr class="claro"><td><b>Fecha Compromiso Taller: </b></td><td>';
					...
					//					$myCalendar->dateAllow(date("Y-m-d"), "2020-12-31");
								...
								echo '			 	<tr class="obscuro"><td><b>Promesa de entrega: </b></td><td class="' . $alerta_fecha . '">' . $orden['orden_fecha_promesa_de_entrega'];
								if($fpromesa == 1) {
									// ------------  Habilitar el despliegue de fecha compromiso de Centro de Reparación ( que es diferente de la 
									// ------------  "Fecha Promesa de Entrega" requerida por aseguradoras  
								...
								echo '			 	<tr class="claro"><td><b>Fecha de valuación: </b></td><td>';
								...
								// ------ Prersentación de Fecha de termino de producción ------
									echo '			 	<tr class="obscuro"><td><b>' . $lang['TermProd'] . '</b></td><td>' . $orden['orden_fecha_proceso_fin'];
								...
								echo '		 		<tr class="obscuro"><td><b>Vehículo Lavado?:</b> </td><td style="text-align:center;">' . constant('ALARMA_' . $orden['orden_lavado']) . '</td></tr>
							 		<tr class="claro"><td><b>Fecha Acordada de Entrega: </b></td><td class="' . $alerta_acordada . '">' . $orden['orden_fecha_acordada'] . '</td></tr>
			     ...
			     <div class="col-lg-1 col-md-2 col-sm-11" style="margin: 5px;">
					<div style="row" align="center">
							...
							if ($num_acc>0) {
								while ($acciones = mysql_fetch_array($matriz4)) {
									...
									if (($acciones['accion_codigo']=='99') || ($_SESSION[$rol]==1)) {
										...
										echo '"><img class="acciones" src="idiomas/' . $idioma . '/imagenes/' . $acciones['accion_descripcion'] . '</a>'."\n";
									}
								}
							}
								if ($orden_estatus>=1 && $orden_estatus<=89 && $orden_estatus != 17 && ($_SESSION['rol05']==1 || $_SESSION['rol06']==1)) {
									echo '				<a href="presupuestos.php?accion=adicional&orden_id=' . $orden_id . '"><img class="acciones" src="idiomas/' . $idioma . '/imagenes/agregar-tarea.png" alt="Agregar otra tarea" title="Agregar otra tarea"></a>'."\n";
								}
								if(($orden_estatus == 17  && $confolio != '1') || $orden_estatus != 17) {
									echo '				<a href="documentos.php?accion=listar&orden_id=' . $orden_id . '"><img class="acciones" src="idiomas/' . $idioma . '/imagenes/documento.png" alt="Mostrar documentos" title="Mostrar documentos"></a>'."\n";
									echo '				<a href="comentarios.php?accion=agregar&orden_id=' . $orden_id . '"><img class="acciones" src="idiomas/' . $idioma . '/imagenes/agregar-comentarios.png" alt="Agregar Comentarios" title="Agregar Comentarios"></a>'."\n";
								}
				...
				<div class="col-lg-3 col-md-5 col-sm-11" style="margin: 5px;">
			    ...
			    <div class="col-lg-9 col-md-6 col-sm-11" style="margin: 5px;">
...
?>
			...
			echo '		<tr><td colspan="3">'."\n";
			echo '			<table cellspacing="2" cellpadding="2" border="0">'."\n";
			echo '		<tr><td colspan="3" style="font-size:1.2em;">
							</td></tr>'."\n";
			echo '			</table></td></tr>'."\n";
			echo '		<tr><td valign="top">'."\n";
			echo '			<table cellspacing="0" cellpadding="0" border="0" style="border-radius: 10px;"><tr><td style="vertical-align:top;">'."\n";
			echo '				<tr><td valign="top"><div style="border-radius: 10px;">'."\n";
			echo '					<table cellspacing="0" cellpadding="2" border="0" width="450px" style="border-radius: 10px;  box-shadow: 3px 4px 10px 0px #484848;">'."\n";
// ---------------------- Estatus general de la OT --------------------
			$promrep = ($promrep / $cuentasub);
			echo '						<tr><td colspan="5" style=" background-color: white; border-top-right-radius: 10px; border-top-left-radius: 10px;">'."\n";
			echo '							<table cellspacing="0" cellpadding="2" border="0" width="100%">'."\n";
			echo '								<tr><td style="width:52px;">';
			echo constant('ALARMA_' . $orden['orden_alerta']);
			echo '</td><td style="vertical-align:top;">';
			echo '<b>' . constant('ORDEN_ESTATUS_' . $orden['orden_estatus']) . '</b>';
//			echo '<br>' . $lang['Reparación'] . ' ';
//			if($promrep == 2) { echo $lang['terminada']; }
//			elseif($promrep > 0) { echo $lang['en progreso']; }
//			else { echo $lang['por iniciar']; }
			...
			echo '				</td></tr>'."\n";
// --------------------------------------------------------------------			
			echo '				<tr><td style="vertical-align:top; width:220px; text-align:center;" colspan="7">';
...
//						echo $sindet['ase'] . ' ' . ' ' . $alerta['orden_id'] . ' ' . $k;
				...
				if(($_SESSION['codigo'] >= '2000' && $mostrar == 0) || ($restrictotoper == 1 && ($_SESSION['codigo'] >= '60' && $_SESSION['codigo'] <= '75'))) {
					...
					echo '				<tr><td colspan="5"><a name="' . $sin . '"></a><hr style="color: #2c5ba0;height: 15px;background-color: #2c5ba0;margin-top: 10px;margin-bottom: 10px;">'."\n";
					echo '						<table cellspacing="0" cellpadding="2" border="0" width="100%" style="background-color: ; text-align:right; line-height:12px;">'."\n";
//				print_r($sindet);
...
// --------- Generales de OT ------------------------------------------
	/*	echo '			<td style="width:15px;"></td>'."\n";
		echo '			<td style="vertical-align:top; width="350px">'."\n";
		echo ' 			<table cellspacing="0 cellpadding="2" border="0" width="100%">
							<tbody>
								<tr> <td align="center">
								<div style="box-shadow: 3px 4px 10px 0px #484848;background-color: white; width: 390px; border-radius: 10px;">
								<h2 style="padding-top: 10px;padding-bottom: 10px;"><b>' . $vehiculo['marca'] . ' ' . $vehiculo['tipo'] . ' ' . $vehiculo['color'] . ' ' . $vehiculo['modelo'];
			if($vehiculo['flota'] > 0) {
				echo ' ' . $lang['NumEco'];
				if($vehiculo['placas']=='') {
					echo $orden['orden_vehiculo_tipo'];
			...
			echo '</b></h2></div><br>
								...
								<div class="image-box" style="box-shadow: 3px 4px 10px 0px #484848; border-radius: 10px;">
  									<a href="' . $vehiculo['imagen'] . '" target="_blank" title="' . $vehiculo['marca'] . ' ' . $vehiculo['tipo'] . '  ' . $vehiculo['modelo'] . '  ' . $vehiculo['color'] . '">';
						...
						echo '<table style="box-shadow: 3px 4px 10px 0px #484848; border-radius: 10px;" width="390px"><tr><td>';
		echo '				<table cellspacing="0" cellpadding="2" border="0" width="100%">'."\n";
		echo '					<tr class="claro"><td style="text-align:center;"><img src="imagenes/avatar.png" alt="Asesor de Servicio" title="Asesor de Servicio"></td>
...
/*
				...
				<div id="navegador"><a name="com"></a><br>
					...
					echo '			<tr><td colspan="3" style="width:650px; "><div name="HOLA" style="box-shadow: 3px 4px 10px 0px #484848; border-radius: 10px;">';
					if($com == '') {
						$com = '1';
					}	
					if($com == '1' && ($per_generales == 1 || ($_SESSION['codigo'] != '70' && $_SESSION['codigo'] != '75'))) {
...
// ------  Acciones ------ 
	/*		echo '			</table>'."\n";
			...
			echo '		</td><td width="15px"></td><td valign="top"><div align="center" style="background-color: #b0b0b0; box-shadow: 3px 4px 10px 0px #484848;">
			<h3>Acciones</h3>';
			$orden_estatus = $orden['orden_estatus'];
			$pregunta4 = "SELECT * FROM " . $dbpfx . "acciones WHERE accion_estatus = '".$orden['orden_estatus']."'";
			$matriz4 = mysql_query($pregunta4) or die("ERROR: Fallo selección! " . $pregunta4);
			...
			if ($num_acc>0) {
				...
				echo '	</div></td>'."\n";
				echo '	<td width="15px"></td><td style="vertical-align:top; text-align:left; width:300px;">'."\n";
				if($mensjint == '1') {
      			echo '				<form action="comentarios.php?accion=visto" method="post" enctype="multipart/form-data">'."\n";
				...
				// ----------------------- sección de comentarios -------------------------
      			/*echo '
							<table width="100%">
								<tr>
									<td style="border-width:0px; border-style:solid; text-align:left; box-shadow: 3px 4px 10px 0px #484848; border-radius: 10px;">Tus mensajes no leidos:<br>'."\n";
...
elseif ($accion==='otcambiar') {
	...
	if((validaAcceso('1120005', $dbpfx) == '1' || validaAcceso('1040125', $dbpfx) == 1) || ($solovalacc != 1 && ($_SESSION['rol02']=='1' || $_SESSION['rol04']=='1' || $_SESSION['rol06']=='1'))) {
		...
		if($ord['orden_servicio'] == '4') {
			...
			<div class="col-md-8" style="box-shadow: 3px 4px 10px 0px #484848; border-radius: 10px; margin-bottom: 10px; margin-left: 10px;">
